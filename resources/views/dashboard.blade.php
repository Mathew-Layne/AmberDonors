...
<body class='h-full'>
        ...
        <div class="container px-4 mx-auto flex flex-wrap items-center ">
            <div class="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start"> <a
                    ...
                    type="button" onclick="toggleNavbar('example-collapse-navbar')"> <i
                        class="text-white fas fa-bars"></i> </button>
            </div>
    ...
    <div class="text-gray-800 antialiased">
        <main>
                    ...
                    <div class="items-center flex flex-wrap">
                        <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                            <div class="pr-12">
                                ...
                                <p class="mt-4 text-lg text-gray-300"> You Can’t Buy A Life For Someone With Money, But
                                    You Can Save
                        ...
                        <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                            <div
                                ...
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <p class="mt-2 mb-4 text-gray-600"> Amber Donors engaged new leadership and
                                        re-invigorated its strategy and operations.</p>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-4/12 px-4 text-center">
                            <div
                                ...
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <p class="mt-2 mb-4 text-gray-600"> Amber Donors helps purchase Trima technology for
                                        Nigeria, enabling stem cell transplantation for the first time. </p>
                                </div>
                            </div>
                        </div>
                        <div class="pt-6 w-full md:w-4/12 px-4 text-center">
                            <div
                                ...
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <p class="mt-2 mb-4 text-gray-600"> Amber Donors signs MoU with AABB (American
                    ...
                    <div class="flex flex-wrap items-center mt-24">
                        <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
                            <div
                                ...
                                <i class="fas fa-tint text-xl text-pink-600"></i>
                            </div>
                            <h3 class="text-3xl mb-2 font-semibold leading-normal">Blood Donation</h3>
                            <p class="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700"> Most blood donors are
                                volunteers. However, sometimes, a patient may want to donate blood a couple of weeks
                                before
                                undergoing surgery, so that his or her blood is available in case of a blood
                                transfusion. Donating blood for yourself is
                                called an autologous donation. Volunteer blood donors must pass certain criteria,
                            ...
                            <ul class="text-lg font-light leading-relaxed mt-0 mb-8  ml-7 text-gray-700">
                                ...
                                <li><i class="fas fa-check text-pink-600"></i> Must be at least 16 years of age, or in
                                    accordance with state law</li>
                                <li><i class="fas fa-check text-pink-600"></i> Must pass the physical and health history
                                    exam given before donation</li>
                            </ul>
                            <a href="https://www.hopkinsmedicine.org/health/treatment-tests-and-therapies/blood-banking"
                                class="font-bold text-gray-500 px-8 py-4 rounded-md bg-gray-50 hover:bg-gray-400 hover:text-gray-50">Learn
                                More</a>
                        </div>
                        <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
                            <div
                                ...
                                <img alt="..."
                                    src="https://images.pexels.com/photos/8460347/pexels-photo-8460347.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
            ...
            <section style="scroll-behavior: smooth" id="aboutUs" class="relative py-20">
                ...
                <div class="container mx-auto px-4">
                    <div class="items-center flex flex-wrap">
                        <div class="lg:w-3/12 md:w-5/12 ml-auto mb-8 mr-auto px-4"> <img alt="..."
                                ...
                                src="https://images.pexels.com/photos/5998474/pexels-photo-5998474.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260" />
                        </div>
            ...
            <section id="contactUs" class="pb-20 relative block bg-gray-900">
                <div class="bottom-auto top-0 left-0 right-0 w-full absolute pointer-events-none overflow-hidden -mt-20"
                    style="height: 80px; transform: translateZ(0px);"> <svg class="absolute bottom-0 overflow-hidden"
                        xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" version="1.1"
                        viewBox="0 0 2560 100" x="0" y="0">
