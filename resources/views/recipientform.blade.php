                        ...
                        <div class="divide-y divide-gray-200">
                            <div class="py-8 text-base leading-6 space-y-2 text-gray-700 sm:text-lg sm:leading-7">
                                <div class="flex flex-col">
                                    <label class="leading-loose">Medical Personnel's Full Name</label>
                                    <input type="text" readonly value="{{ Auth::user()->name }}" name="personnel_name" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
                                    @error('personnel_name')<span class="text-xs text-red-600">{{ $message }}</span>@enderror
                                </div>

                                <div class="flex flex-col">
                                    <label class="leading-loose">Medical Licence Number</label>
                                    <input type="text" value="" name="licence_No" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input type="text" placeholder="Enter Hospital Name" name="hospital_name" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
                                    @error('hospital_name')<span class="text-xs text-red-600">{{ $message }}</span>@enderror
                                </div>

                                <div class="flex flex-col">
                                    <label class="leading-loose">Hospital's Email</label>
                                    <input type="text" placeholder="Enter Institution Email Address" name="hospital_email" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
                                    @error('hospital_email')<span class="text-xs text-red-600">{{ $message }}</span>@enderror
                                </div>
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex flex-col">
                                        ...
                                        <div class="relative focus-within:text-gray-600 text-gray-400">
                                            <input type="text" placeholder="Enter City" name="city" class="pr-4 pl-10 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
                                        </div>
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <div class="relative focus-within:text-gray-600 text-gray-400">
                                            ...
                                            <select name="parish" class="pr-4 pl-10 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
                            ...
                            <div class="pt-4 flex items-center">
                                <button type="submit" class="bg-red-600 flex justify-center items-center w-full text-white px-4 py-3 rounded-md focus:outline-none font-bold">Register</button>
                            </div>
                        </div>
                    </form>
