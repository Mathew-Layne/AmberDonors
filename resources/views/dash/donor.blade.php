                                    ...
                                    <table class="min-w-full border-collapse block md:table">
                                        ...
                                        <tbody class="block md:table-row-group">
                                            ...
                                            <tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
                                                ...
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                                                        class="inline-block w-1/3 md:hidden font-bold">Address</span>{{ $donation->donation_address }}
                                                </td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                                                        class="inline-block w-1/3 md:hidden font-bold">City</span>{{ $donation->city }}</td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                                                        class="inline-block w-1/3 md:hidden font-bold">Parish</span>{{ $donation->parish }}
                                                </td>
                                                <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
